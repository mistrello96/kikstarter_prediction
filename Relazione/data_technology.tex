...
\captionof{table}{Tabella riassuntiva che mostra il numero di tuple che non soddisfano i vincoli di consistenza o di correttezza sintattica prima e dopo le trasformazioni applicate}

\begin{tabular}{|c|c|c|}
	\hline 
	Misura & Pre-trasformazione & Post-trasformazione \\ 
	\hline 
	Correttezza sintattica state & 406 & 0 \\ 
	\hline 
	Consistenza state & 524 & 0 \\ 
	\hline 
	Correttezza sintattica country code & 141 & 0 \\ 
	\hline 
